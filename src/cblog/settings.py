...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ckh7r7iuwowb.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesmetinsblog' # please enter your s3 bucket name
